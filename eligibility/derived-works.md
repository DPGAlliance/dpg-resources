...
- [Three Pillars of Distinction](#three-pillars-of-distinction)
- [How We Categorise Derived Projects](#how-we-categorise-derived-projects)
- [A Note on Deployments and Digital Sovereignty](#a-note-on-deployments-and-digital-sovereignty)
- [What Applicants Should Provide](#what-applicants-should-provide)
  - [Relationship to the Parent Project](#relationship-to-the-parent-project)
  - [Your Meaningful Distinction](#your-meaningful-distinction)
  - [Governance and Sustainability](#governance-and-sustainability)
- [Illustrative Archetypes](#illustrative-archetypes)
- [Our Commitment to Applicants](#our-commitment-to-applicants)

---

## Purpose

The DPG Registry lists solutions that provide genuine public value. As the ecosystem grows, we receive an increasing number of applications from projects that are derived from — or built on top of — existing DPGs or open-source software. This framework explains how we evaluate those projects.

Our goal is to keep the registry useful and discoverable, while recognising that meaningful innovations often build on existing foundations.
...
- A **distribution** — a curated bundle, configuration, or packaging of an existing project (e.g., a Linux distribution, a CMS distribution, etc.).
- A **vertical build** — a specialised implementation of a broader platform tailored to a specific sector or geography.

> [!Note]
> This framework does not apply to projects that merely reference or integrate with other DPGs as dependencies.
...
- If the answer is clearly yes, the project stands on its own.
- If the answer is unclear or marginal, reviewers will assess it against the three pillars below.
- If the answer is no, applicants are encouraged to contribute their work upstream and be recognised as contributors to the existing DPG.

---

## Three Pillars of Distinction

A derived project should demonstrate a meaningful distinction in at least one of the following areas. These pillars are equal — a strong case in any one of them is sufficient.

| Pillar | What It Means | Illustrative Examples |
|---|---|---|
| **1. Functional Innovation** | The project adds substantial features, APIs, or capabilities not present in the parent project. **UI reskins, rebranding, and minor configuration changes do NOT qualify**. | Offline-first data collection mode, integrated national ID verification layer, novel API for cross-sector interoperability, etc. |
...
## How We Categorise Derived Projects
...
| **Requires Review** | The project shows some distinction, but it is not immediately clear whether it meets the threshold. This typically includes specialised distributions with sector-specific configuration or packaging that goes beyond cosmetic changes, but where the functional or SDG delta needs to be articulated more clearly by the applicant. | Reviewer assessment |
| **Eligible** | The project demonstrates a clear, meaningful distinction in at least one of the three pillars. It provides unique value to users and the broader ecosystem that is not already captured by the parent DPG. | Listed |

---

## A Note on Deployments and Digital Sovereignty

We recognise that many governments and institutions create localised deployments of open-source platforms — adding local language packs, security policies, national branding, or procurement configurations. This practice is valuable and represents exactly the kind of digital sovereignty the DPG ecosystem aims to enable.

However, deploying a DPG is not the same as creating a new Digital Public Good. If a government agency configures an existing DPG for local use, we encourage them to:
...
- Is your project recognised or endorsed by the parent community?
...
The following archetypes illustrate how the framework applies. These are generalised examples, not references to specific projects.
...
| **Sector-Specific Distribution** | A civil society organisation packages an existing platform, along with substantial domain-specific data models, workflows, and integrations, designed for a specific underserved sector. The packaging work itself represents meaningful intellectual property and aligns with the SDGs. | Requires Review → Likely Eligible |
...
We understand that the line between a "deployment" and a "distinct DPG" is sometimes genuinely unclear. If your project falls in a grey area, we encourage you to:
